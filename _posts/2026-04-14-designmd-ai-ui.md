...
- "Design search bar: white background, full card shadow, 32px radius..."
- "Build category pill bar: horizontal scrollable row..."

### Iteration Guide
1. Start with white — the photography provides all the color
2. Rausch Red (#ff385c) is the singular accent — use sparingly
...
```

**Example Component Prompts** 是可以直接复制用的提示词模板，告诉 AI "用这个规格创建一个卡片"、"设计一个搜索栏"。**Iteration Guide** 是 7 条设计迭代原则，让 AI 在生成过程中遵循这些规则。
